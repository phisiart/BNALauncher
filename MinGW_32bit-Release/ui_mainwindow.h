...
public:
    ...
    QLineEdit *lineEditCUCorMat_to_save_cormatrix;
    QLabel *label;
    ...
    QLineEdit *lineEditCUCorMat_to_average;
    QLabel *label_2;
    ...
    QLineEdit *lineEditCUCorMat_threshold_type;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        lineEditCUCorMat_to_save_cormatrix = new QLineEdit(layoutWidget);
        lineEditCUCorMat_to_save_cormatrix->setObjectName(QStringLiteral("lineEditCUCorMat_to_save_cormatrix"));

        gridLayout->addWidget(lineEditCUCorMat_to_save_cormatrix, 4, 6, 1, 1);
        ...
        lineEditCUCorMat_to_average = new QLineEdit(layoutWidget);
        lineEditCUCorMat_to_average->setObjectName(QStringLiteral("lineEditCUCorMat_to_average"));

        gridLayout->addWidget(lineEditCUCorMat_to_average, 3, 6, 1, 1);
        ...
        lineEditCUCorMat_threshold_type = new QLineEdit(layoutWidget);
        lineEditCUCorMat_threshold_type->setObjectName(QStringLiteral("lineEditCUCorMat_threshold_type"));

        gridLayout->addWidget(lineEditCUCorMat_threshold_type, 5, 6, 1, 1);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        checkL_Modularity->setText(QApplication::translate("MainWindow", "L_Modularity", 0));
